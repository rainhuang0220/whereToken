...
export const onboardTitle = '连接你的第一台设备'
export const neverSyncedTitle = '还没有同步用量'
export const pairTitle = '连接一台设备'
export const pairSuccessTitle = '设备已连接'
export const pairSuccessBody = '可以回到终端。whereToken 会自动继续。'

export const syncedItems = ['token counts', 'models & vendors', 'request statistics'] as const
export const neverSyncedItems = ['prompts', 'source code', 'file paths', 'API keys'] as const
