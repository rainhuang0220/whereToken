...
body{
  ...
  background-image:url("../../internal/profilewebembed/static/assets/newsprint-surface.jpg");
...
<p class="copy"><strong>whereToken local token accounting</strong><br>Coldset ink multiplies into a height-lit uncoated sheet. Type stays crisp; the substrate carries felt, calendering, and a soft desk key.</p>
</body></html>
`, displayWidthCSS)
	return []byte(body)
}
