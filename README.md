...
Read-only local ledgers. HTTP binds `127.0.0.1` only. No telemetry. The CLI never prints JWTs, access tokens, API keys, or cookies. Do not paste secrets into issues. See [`SECURITY.md`](SECURITY.md).
